...
var roleWorker = {
    ...
    run: function(creep) {
        if(creep.ticksToLive < 10){
            ...
            let container = creep.pos.findClosestByPath(FIND_STRUCTURES, {filter:function(o){ return o.structureType === STRUCTURE_CONTAINER && o.store[RESOURCE_ENERGY] > 0}});
            if(creep.withdraw(container, RESOURCE_ENERGY) === ERR_NOT_IN_RANGE){
                creep.moveTo(container);
            }
            if(creep.store.getFreeCapacity() <= 0){
                creep.memory.job = null;                                                        //TODO: After creep is no longer empty, creep gets assignment but job is deleted
            }
            ...
            let assignment = creep.pos.findClosestByPath(FIND_MY_STRUCTURES, {filter:function(o){ 
                ...
                return ((o.structureType === STRUCTURE_SPAWN || o.structureType === STRUCTURE_EXTENSION) && o.store.getFreeCapacity(RESOURCE_ENERGY) > 0 && !(claimed));
            }});
